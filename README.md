...
## 어떻게 푸는가?
  ...
  * 시연 링크 https://www.youtube.com/watch?v=-PvmYjnA3vk
...
* Arduino 1과 2가 블루투스로 연결되어 있으며, 시리얼 통신을 사용한다.
* Arduino 1 : 저장된 wav파일을 서버로 전송, 결과값을 서버로부터 받음, 해당 출력을 Arduino 2로 블루투스를 이용해 전달
* Arduino 2 : Arduino 1으로 부터 받은 시리얼 값을 통해 LED와 진동 출력
